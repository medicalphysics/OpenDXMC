...
public:
	...
	virtual double getCalibrationValue(std::uint64_t nHistories) = 0;
...
public:
	...
	double getCalibrationValue(std::uint64_t nHistories) override;
...
public:
	...
	virtual double getCalibrationValue(std::uint64_t nHistories) override;
