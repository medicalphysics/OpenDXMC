...
class ImageThresholdMultiple : public vtkThreadedImageAlgorithm
{
public:
	static ImageThresholdMultiple *New();
	vtkTypeMacro(ImageThresholdMultiple, vtkThreadedImageAlgorithm);
...
protected:
	ImageThresholdMultiple();
	~ImageThresholdMultiple() override {}
...
private:
	ImageThresholdMultiple(const ImageThresholdMultiple&) = delete;
	void operator=(const ImageThresholdMultiple&) = delete;
};
