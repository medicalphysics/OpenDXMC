...
#include "imagethresholdmultiple.h"
...
vtkStandardNewMacro(ImageThresholdMultiple);

//----------------------------------------------------------------------------
// Constructor sets default values
ImageThresholdMultiple::ImageThresholdMultiple()
{
...
//----------------------------------------------------------------------------
void ImageThresholdMultiple::SetInValue(double val)
{
...
//----------------------------------------------------------------------------
void ImageThresholdMultiple::SetOutValue(double val)
{
...
void ImageThresholdMultiple::ThresholdByUpper(double thresh)
{
...
void ImageThresholdMultiple::ThresholdByLower(double thresh)
{
...
void ImageThresholdMultiple::ThresholdBetween(double lower, double upper)
{
...
//----------------------------------------------------------------------------
int ImageThresholdMultiple::RequestInformation(
...
void ImageThresholdMultipleExecute(ImageThresholdMultiple *self,
	vtkImageData *inData,
...
//----------------------------------------------------------------------------
template <class T>
void ImageThresholdMultipleExecute1(ImageThresholdMultiple *self,
	vtkImageData *inData,
	vtkImageData *outData,
	int outExt[6], int id, T *)
{
	...
	{
		vtkTemplateMacro(
			ImageThresholdMultipleExecute(self, inData,
				outData, outExt, id,
...
void ImageThresholdMultiple::ThreadedRequestData(
	vtkInformation *vtkNotUsed(request),
	...
	int outExt[6], int id)
{
	...
	{
		vtkTemplateMacro(
			ImageThresholdMultipleExecute1(this,
				inData[0][0],
				outData[0],
				outExt,
				id,
...
//----------------------------------------------------------------------------
void ImageThresholdMultiple::PrintSelf(ostream& os, vtkIndent indent)
{
